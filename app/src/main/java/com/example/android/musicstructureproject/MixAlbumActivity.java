...
public class MixAlbumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_mix_album);
        ...
        songs.add (new Songs (R.string.song3, R.string.album1, R.drawable.album1icon, R.drawable.album1, R.raw.song3, false));
        songs.add (new Songs (R.string.song4, R.string.album6, R.drawable.album6icon, R.drawable.album6, R.raw.song4, false));
        ...
        songs.add (new Songs (R.string.song7, R.string.album6, R.drawable.album6icon, R.drawable.album6, R.raw.song7, false));
        songs.add (new Songs (R.string.song8, R.string.album6, R.drawable.album6icon, R.drawable.album6, R.raw.song8, false));
        songs.add (new Songs (R.string.song9, R.string.album1, R.drawable.album1icon, R.drawable.album1, R.raw.song9, false));
        songs.add (new Songs (R.string.song10, R.string.album3, R.drawable.album3icon, R.drawable.album3, R.raw.song10, false));
        songs.add (new Songs (R.string.song11, R.string.album6, R.drawable.album6icon, R.drawable.album6, R.raw.song11, false));
        ...
        songs.add (new Songs (R.string.song14, R.string.album6, R.drawable.album6icon, R.drawable.album6, R.raw.song14, false));
        songs.add (new Songs (R.string.song15, R.string.album6, R.drawable.album6icon, R.drawable.album6, R.raw.song15, false));
        songs.add (new Songs (R.string.song16, R.string.album6, R.drawable.album6icon, R.drawable.album6, R.raw.song16, false));
        ...
        // activity_mix_album.xml layout file.
        ...
        listView.setOnItemClickListener (new AdapterView.OnItemClickListener () {
            ...
            public void onItemClick(AdapterView <?> adapterView, View view, final int position, long l) {
                ...
                openTheSongMenu (position, songs);
            }
    ...
    private void openTheSongMenu(int playListPosition, final ArrayList <Songs> songs) {

        globalPosition = playListPosition;

        final Songs song = songs.get (playListPosition);
        ...
        if (song.customPlaylistAdded ()) favoriteButton.setImageResource (R.drawable.favoritered);
        else favoriteButton.setImageResource (R.drawable.favoritewhite);


        // Find the Forward Button ImageView
        ...
        backToPlaylistButton.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                releaseMediaPlayer ();
                Intent mixAlbumIntent = new Intent (getBaseContext (), MixAlbumActivity.class);
        ...
        forwardButton.setOnClickListener (new View.OnClickListener () {
            @Override
            public void onClick(View view) {
                if (globalPosition < (songs.size () - 1)) {
                    releaseMediaPlayer ();
                    openTheSongMenu (globalPosition + 1, songs);
                } else
        ...
        favoriteButton.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                ...
                if (!song.customPlaylistAdded ()) {
                    ...
                    song.addToCustomPlaylist ();
                } else {
                    favoriteButton.setImageResource (R.drawable.favoritewhite);
                    song.removeFromCustomPlaylist ();
                }
                songs.remove (globalPosition);
                songs.add (globalPosition, song);
